...
> Vendored reference, kept verbatim from https://interfaces.dev/cheat-sheet
> (operator request, 2026-08-24). Apply these when adapting shadcn/Base UI
> components or writing any webui surface; where a rule conflicts with
> `design-system.md`, the design system wins.
