...
- US-R1-002 - Review round 1 fix 002: address reviewer finding
- US-R1-001 - Review round 1 fix 001: address reviewer finding
- US-003 - Add the naming-decision section to docs/positioning.md
- US-002 - Create docs/positioning.md: category, unique-position thesis, competitive landscape
- US-001 - Write ADR 0049: the Garboard naming policy
...
- US-001 - Deterministic idle-wait in bootPane setup to kill the UNDELIVERED send-once flake
...
- US-001 - Condense dispatch.ts leading comment header
...
- US-001 - Extract withFakeClock helper and migrate both dispatch.test.ts sites
...
- US-001 - Correct stale idleTimeoutMs default JSDoc in the three thin-proxy commands

## [0.231.0] - 2026-07-21

### Added

- US-001 - Send-once guard on the idle verify/retry path in sendKeysVerified
...
- US-R1-002 - Review round 1 fix 002: address reviewer finding
- US-R1-001 - Review round 1 fix 001: address reviewer finding
- US-001 - Add the oracle-falsifiability rule to the knowledge layer
...
- US-R1-001 - Review round 1 fix 001: address reviewer finding
- US-001 - Capture stderr in plan-preflight failure detail
...
- US-001 - Reconcile Recent feed 'incomplete' against live prd.json passes

## [0.206.0] - 2026-07-18

### Added

- US-001 - Document the sync-read carve-out to the Bun-first invariant

## [0.205.0] - 2026-07-18

### Added

- US-001 - Pin hardcoded full-string argv goldens in backend-adapter.test.ts

## [0.204.0] - 2026-07-18

### Added

- US-001 - Bound verb/config co-occurrence cue to a single field
