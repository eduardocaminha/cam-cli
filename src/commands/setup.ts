...
function buildSetupPrompt(opts: {
	...
	const base = [
		...
		'  .claude/agents/    (prd-implementer.md, reviewer.md, prd-auditor.md)',
		'  scripts/cam/       (CLAUDE.md, planner.md, handoff.schema.json)',
		'',
		...
		'3. Update scripts/cam/planner.md: project name, stack, domain terms.',
		'4. Update .claude/agents/reviewer.md checklist: real framework, auth, data patterns.',
		'5. Update .claude/agents/prd-implementer.md: real quality-gate commands.',
		'6. Update .claude/agents/prd-auditor.md § F.domain: project-specific sanity checks.',
		'7. Replace ALL occurrences of generic placeholder text (e.g. "<project typecheck command>").',
		'8. When done, print exactly: CAM_SETUP_STATUS=DONE',
	].join('\n');
