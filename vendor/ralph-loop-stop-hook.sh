...
# sha256: 13c547e77956e44f6af41d1be140f55da0e1ee3c55a540b530f48ee7c7ba9a11
#
# Do NOT edit this file by hand. To update, re-run the drift-detection ceremony
# documented in vendor/README.md and copy the upstream file verbatim (minus this
# header). Drift between this file and the baseline sha256 documented in README.md
# will cause `bun test` to fail.
